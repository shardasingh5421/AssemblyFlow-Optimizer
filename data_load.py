...
# But make sure to convert types to actual values in the schema document
schema_document = {field: type([]) if isinstance(type, list) else type() for field, type in schema.items()}
workload_data.insert_one(schema_document)
